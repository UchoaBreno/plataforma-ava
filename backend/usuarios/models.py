...
class Quiz(models.Model):
    """Quiz com questões e alternativas"""
...
class RespostaQuiz(models.Model):
    """Respostas enviadas por alunos para quizzes"""
    aluno        = models.ForeignKey(Usuario, on_delete=models.CASCADE)
    quiz         = models.ForeignKey(Quiz, on_delete=models.CASCADE)
    resposta     = models.JSONField()  # Ex: {"1": 4, "2": 7}
...
class Atividade(models.Model):
    """Provas e trabalhos com pontos postados pelo professor"""

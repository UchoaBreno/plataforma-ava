...
export default function ForumAluno() {
  ...
  return (
    <div className="min-h-screen bg-gray-100 dark:bg-gray-900 text-gray-900 dark:text-gray-100 p-4 sm:p-6 max-w-4xl mx-auto relative">
      <button
        className="absolute top-4 right-4 text-xs sm:text-sm bg-gray-300 dark:bg-gray-700 hover:bg-gray-400 dark:hover:bg-gray-600 px-3 py-1 sm:px-4 sm:py-2 rounded"
        onClick={() => navigate(-1)}
      >
        Voltar
      </button>
